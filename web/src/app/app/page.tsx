    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="border-b border-white/[0.06] px-6 h-14 flex items-center justify-between bg-black/80 backdrop-blur-xl fixed top-0 left-0 right-0 z-50">
        <Link href="/" className="flex items-center gap-2 group">
          <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-purple-500 to-violet-600 flex items-center justify-center text-xs font-bold shadow-lg shadow-purple-500/20">
            P
          </div>
          <span className="text-sm font-heading font-semibold">Parl</span>
          <span className="text-xs text-white/30 ml-1 font-body">/ markets</span>
        </Link>
